...
class CarDetailAgency extends StatefulWidget {
  const CarDetailAgency({super.key, required this.car});
  final Car car;

  @override
  State<CarDetailAgency> createState() => _CarDetailAgencyState();
}

class _CarDetailAgencyState extends State<CarDetailAgency>
